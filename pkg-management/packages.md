#### apathy pkg and dependency list
* last updated: `sat 31 aug 2019 06:36:42pm +03`
```
[d]	> make-ca-1.3					--> updated from 1.2
[d]	>> p11-kit-0.23.15
[d]	>>> nss-3.44					--> updated from 3.42.1
[d]	>>>> nspr-4.20
[d]	>>> libtasn1-4.13
[d]	>>> libxslt-1.1.33
[d]		>>>> libgcrypt-1.8.4
[d]			>>>>> libgpg-error-1.35
[d]			>>>>> pth-2.0.7
[d]		>>>> libxml2-2.9.9			--> also built the python 2 module
[d]			>>>>> python-2.7.15 
[d]			>>>>>> sqlite-3.27.1
[d]		>>>> docbook-xml-4.5
[d]			>>>>> sgml-common-0.6.3
...
[d]			>>>>> zip-3.0 
[d]			>>>>> ruby-2.6.4p104-libre 	--> updated from 2.6.1p33-nonfree >> 2.6.3p62-libre
[d]			>>>>>> yaml-0.2.1
...
[d]			>>>> openssh-7.9p1		--> no config or init script.
[d]		>>> nghttp2-1.36.0
[d]			>>>> boost-1.69.0
[d]			>>>>> icu-63.1
[d]			>>>> jansson-2.12
...
[r]	> sudo-1.8.27					--> replaced with doas
...
[d]	> mesa-19.2.0-rc4				--> updated from 18.3.6 >> 19.0.4 >> 19.2.0-rc1 >> 19.2.0-rc2
[d]	>> libdrm-2.4.97 
[d]	>> libvdpau-1.1.1 
[d]	>> mako-1.0.7
[d]		>>> markupsafe-1.1.0
...
[d]	> xorg-drivers					--> using modesetting for intel
[d]	>> libevdev 
...
[r]	> llvm-8.0.1 (clang, compiler-rt)		--> updated from 7.0.1
[d]	>> cmake-3.13.4
[d]	>>> libuv-1.26.0
[d]	>>> libarchive-3.3.3
[d]	>>>> lzo-2.10

[r]	> rustc-1.35.0					--> updated from 1.32.0 >> 1.34.2 >> 1.35.0
[d]	> lua-5.3.5
[d]	> luajit 2.0.5-27
[d]	> usbutils-010
[d]	>> libusb-1.0.22
...
[d]	>> autoconf-2.13
[r]	>> cbindgen-0.8.7				--> updated from 0.8.7
[r]	>> nodejs-10.15.1
[d]	>> libwebp-1.0.2
[r]	>> libproxy
[d]	>> yasm
 !!	must build ffmpeg as it's a runtime dep.
...
[d]	> tree-1.8.0
[d]	> rsync-3.1.3					--> no init or config.
[d]	>> popt-1.16
...
[d]	>> libksba-1.3.5
[d]	>> npth-1.6
[d]	>> pinentry-1.1.0				--> tty/curses only
...
[r]	> newsboat					--> replaced with sfeed
[r]	>> json-c
[r]	>> stfl
[r]	>> swig
...
[d]	> start-stop-daemon				--> https://github.com/daleobrien/start-stop-daemon
[r]	> ranger					--> replaced with fbv
...
---------------------------------------------------------
#### lfs-8.4 base
> base is on par with 9.0-rc1 as of apathy 1.3, except for glibc and openssl.)
```
[r] man-pages-4.16
[d] glibc-2.29
[d] zlib-1.2.11
...
[d] gcc-9.2.0						--> updated from 8.2.0 >> 9.1.0 >> 9.2.0 >> 10.0.0-20190901 >> 8.3.0
...
[d] gdbm-1.18.1
[d] gperf-3.1
[d] expat-2.2.6						--> updated from 2.2.7
[d] inetutils-1.9.4
[d] perl-5.28.1
[d] xml::parser-2.44
[d] intltool-0.51.0
...
[d] sysklogd-1.5.1
[d] sysvinit-2.96					--> updated from 2.93 >> 2.95
[d] eudev-3.2.8						--> updated from 3.2.7
```
