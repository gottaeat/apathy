...
pref("font.name.monospace.ja", "Cousine");
pref("font.name.monospace.x-western", "Cousine");
pref("font.name.sans-serif.ja", "Arimo");
pref("font.name.sans-serif.x-western", "Arimo");
pref("font.name.serif.ja", "Tinos");
pref("font.name.serif.x-western", "Tinos");
